...
import { View, Text, StyleSheet, TouchableOpacity, Alert, ScrollView, ActivityIndicator, TextInput, Button } from 'react-native';
...
export default function IndexScreen() {
    ...
    const SECRET_KEY = "kiitos-admin"; // Define tu clave aquí
    ...
    if (!isAuthorized) {
        return (
            <View style={authStyles.container}>
                <Text style={authStyles.title}>🔒 Área Restringida</Text>
                <Text style={authStyles.subtitle}>Solo para desarrolladores</Text>
                <TextInput
                ...
                <Button
                    title="Acceder"
                    onPress={() => password === SECRET_KEY ? setIsAuthorized(true) : Alert.alert('Error', 'Clave incorrecta')}
                />
            </View>
        );
    }
